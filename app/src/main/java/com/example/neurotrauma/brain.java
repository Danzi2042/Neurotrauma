...
public class brain extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        operations.add( new Operation("Припадок", "Первая помощь Удаление из небезопасной среды Лечение причин Прогноз В зависимости от причины может быть опасным для жизни Вызвано Инсульт, ацидоз, алкалоз, лучевая болезнь Вызывает Мышечные спазмы.",
                R.drawable.fever));
        operations.add( new Operation("Без сознания", "Первая помощь Удаление из небезопасной среды, Лечение причин, Прогноз Зависит от причины. Приводит к тому, что все психические симптомы становятся невидимыми, Вызвано Гипотония, состояние здоровья ниже 0, кома, нейротравма.",
                R.drawable.unconscious));
        operations.add( new Operation("Рвота", "Первая помощь Отсутствует, Лечение причин, Прогноз Зависит от причины, Вызвано, Почечная недостаточность, алкогольная интоксикация.",
                R.drawable.vomithing));
        operations.add( new Operation("Тошнота", "Первая помощь Отсутствует, Лечение причин, Прогноз Зависит от причины, Вызвано Почечная недостаточность, алкогольная интоксикация, лучевая болезнь.",
                R.drawable.vomithing));
        operations.add( new Operation("Головная боль", "Первая помощь Отсутствует, Лечение причин, Прогноз Зависит от причины, Вызвано кровопотеря, ацидоз, инсульт, гипоксемия, гипотония.",
                R.drawable.dizziness));
        operations.add( new Operation("Легкое головокружение", "Первая помощь Отсутствует, Лечение причин, Прогноз Зависит от причины гипотонии, Вызвано Гипотония.",
                R.drawable.dizziness));
        operations.add( new Operation("Спутанность сознания", "Первая помощь Отсутствует, Лечение причин, Прогноз Зависит от причины, Вызвано Ацидоз, гипотония, гипоксемия, сепсис.",
                R.drawable.dizziness));
        operations.add( new Operation("Размытое зрение", "Первая помощь Отсутствует, Лечение причин, Прогноз Зависит от причины гипотонии, Вызван Гипотония.",
