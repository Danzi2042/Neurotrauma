...
public class blood extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        operations.add( new Operation("Гипоксемия", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Зависит от степени тяжести, Вызвано Кислородное голодание, кровопотеря, остановка сердца, повреждение сердца, гипотония, гиповентиляция, одышка, повреждение легких, Вызывает Гипервентиляция, одышка, нейротравма, спутанность сознания, головная боль, остановка сердца, остановка дыхания, повреждение органов.",
                R.drawable.hypoxemia));
        operations.add( new Operation("Гипотония", "Первая помощь Внутривенные жидкости, адреналин, Лечение основных причин, Прогноз Зависит от степени тяжести, Вызвано Пневмоторакс, сепсис, повреждение сердца, кровопотеря, введение несовместимой группы крови, Вызывает Тахикардия, гипоксемия, бледность кожи, гипервентиляция, головокружение, нечеткость зрения, повреждение почек, остановка сердца, потеря сознания.",
                R.drawable.hypotension));
        operations.add( new Operation("Гипертония", "Первая помощь Сбор крови, Лечение основных причин, Прогноз Смертельно опасен в тяжелых случаях, Вызвано Чрезмерное внутривенное введение, поражение печени, адреналин, Вызывает Тахикардия, отеки ног, сердечный приступ, инсульт.",
                R.drawable.hypertension));
        operations.add( new Operation("Ацидоз", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Выживают, Вызвано Солевой раствор, гиповентиляция, Вызывает Тахикардия, головная боль, слабость, спутанность сознания, тошнота, судороги, кома.",
                R.drawable.internal_bleeding));
        operations.add( new Operation("Алкалоз", "Первая помощь Физраствор + сбор крови, Лечение основных причин, Прогноз Выживают, Вызвано Гипервентиляция, Вызывает Потливость, сердцебиение, судороги.",
                R.drawable.internal_bleeding));
        operations.add( new Operation("Бледная кожа", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Выживают, Вызвано Кровопотеря, гипотония.",
