...
public class cyberneticsAndEyes extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        operations.add( new Operation("аутоиммунную ретинопатия", "Причина иммуниет во время операции на глаза не был подавлен Прогноз выживают при своевременном  вмешательстве медика.",
                R.drawable.eyeshock));
