...
public class liverAndKidneys extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        operations.add( new Operation("Желтуха", "Первая помощь Отсутствует, Лечение Лечение основных причин, Прогноз Безвредно, Вызвано Поражение печени.",
                R.drawable.jaundice));
        operations.add( new Operation("Вздутие", "Первая помощь Отсутствует, Лечение Лечение основных причин, Прогноз Безвредно, Вызвано Поражение печени.",
