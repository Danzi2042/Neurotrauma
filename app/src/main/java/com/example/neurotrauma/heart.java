...
public class heart extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        operations.add( new Operation("Тремор", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Выживают, Вызвано алкалоз.",
                R.drawable.tremor));
        operations.add( new Operation("Тахикардия / Увеличение частоты сердечных сокращений", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Выживают, потенциально выгодно, Вызвано Сепсис, пневмоторакс, кровопотеря, гипотония, ацидоз, Вызывает Гипертония, счетчики гипоксемии.",
                R.drawable.tremor));
    }
