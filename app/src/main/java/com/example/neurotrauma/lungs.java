...
public class lungs extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        operations.add( new Operation("Остановка дыхания", "Первая помощь СЛР, Лечение основных причин, Прогноз Обычно управляемый, Вызвано Нейротравмa, гипоксемия, передозировка опиатов, Вызывает Низкий уровень кислорода.",
        ...
        operations.add( new Operation("Пневмоторакс", "Первая помощь Игла, Лечение Дренаж во время операции, Прогноз Выживает. мрачный, если развивается достаточно далеко, Вызвано Травма, нелеченный перелом ребра, Вызывает Гипотония, гипоксемия, одышка, тахикардия, гипервентиляция, боль в груди.",
                R.drawable.pneumothorax));
        operations.add( new Operation("Одышка", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Мрачное, Вызвано Введение несовместимой группы крови.",
                R.drawable.dyspnea));
        operations.add( new Operation("Кашель", "Первая помощь Отсутствует, Лечение  основных причин, Прогноз Выживают, Вызвано Повреждение легких, повреждение сердца, остановка сердца.",
                R.drawable.cough));
        operations.add( new Operation("Гиповентиляция", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Выживают, Вызвано Седация, передозировка опиатов, Вызывает Гипоксемия, ацидоз.",
                R.drawable.hypoventilation));
        operations.add( new Operation("Одышка / затрудненное дыхание", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Выживают, Вызвано Сердечный приступ, сердечная недостаточность, гипоксемия, повреждение легких, пневмоторакс, тампонада сердца, Вызывает Гипоксемия.",
                R.drawable.shortness_breath));
        operations.add( new Operation("Гипервентиляция", "Первая помощь Отсутствует, Лечение основных причин, Прогноз Выживают, потенциально выгодны, Вызвано Гипоксемия, гипотензия, пневмоторакс, сепсис, Вызывает Алкалоз, гипоксемия.",
