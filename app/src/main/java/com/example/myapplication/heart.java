...
public class heart extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        operations.add( new Operation("Остановка сердца", "Первая помощь СЛР, дефибриллятор,     Лечение Лечение основных причин,     Прогноз Обычно управляемый,     Вызвано Кровопотеря, гипотония, гипертония, гипоксемия, кома, Вызывает Гипоксемия, кома.",
        ...
        operations.add( new Operation("Повреждение сердца", "Первая помощь    Отсутствует, Лечение    Время, пересадка сердца, Прогноз    Выживают, при прогрессировании сердечной недостаточности - тяжелая форма, Вызвано    Сердечный приступ, сепсис, антибиотики, лучевая болезнь, Вызывает Гипоксемия, гипотензия, сердечная недостаточность, остановка сердца, одышка, отек ног.",
                R.drawable.cardiac_tamponade));
        operations.add( new Operation("Тремор", "Первая помощь Отсутствует,    Лечение    Лечение основных причин, Прогноз Выживают, Вызвано алкалоз.",
                R.drawable.tremor));
        operations.add( new Operation("Тахикардия / Увеличение частоты сердечных сокращений", "Первая помощь     Отсутствует, Лечение    Лечение основных причин, Прогноз Выживают, потенциально выгодно,    Вызвано    Сепсис, пневмоторакс, кровопотеря, гипотония, ацидоз, Вызывает Гипертония, счетчики гипоксемии.",
                R.drawable.tremor));
    }
