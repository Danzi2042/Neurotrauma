...
public class allTrauma extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        operations.add( new Operation("Инородное тело", "Первая помощь Отсутствует, Лечение Операция с пинцетом, Прогноз Выживают, Вызвано Выстрел, Вызывает Воспаление, артериальные порезы при очень сильном воспалении.",
                R.drawable.cardiac_tamponade));
        operations.add( new Operation("Сильная боль", "Первая помощь Опиоиды, Лечение Лечение основных причин, Прогноз Физически безвреден, Вызвано Повреждение органов, вывихи, переломы.",
                R.drawable.cardiac_tamponade));
        operations.add( new Operation("Воспаление", "Первая помощь Отсутствует, Лечение Лечение основных причиy, Прогноз Полезный (помогает в борьбе с инфекцией), Вызвано инфицированные раны, инородные тела.",
                R.drawable.tremor));
        operations.add( new Operation("Спазмы", "Первая помощь Отсутствует, Лечение Лечение основных причин, Прогноз Безвредный, Вызвано Припадки.",
                R.drawable.tremor));
    }
